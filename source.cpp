...
void station()
{
    ...
    renderBitmapString(-0.16f, 0.505f, 0.0f, GLUT_BITMAP_HELVETICA_18, (char*)"COX'S Bazar    Railway Station");
}
...
void busStand()
{
    ...
    glColor3f(1.0, 0.0, 0.0);
    renderBitmapString(0.42f, 0.65f, 0.0f, GLUT_BITMAP_TIMES_ROMAN_10,(char*) " Bus Stand ");
...
void information(void)
{
    ...
    glColor3f(1.0, 0.0, 0.0);
    renderBitmapString(-0.3f, 0.91f, 0.0, GLUT_BITMAP_TIMES_ROMAN_24, (char*)"Cox's Bazar Railway Station : Changes in nature");
    renderBitmapString(-0.14, 0.86, 0.0, GLUT_BITMAP_TIMES_ROMAN_24, (char*)"Computer Graphics [E]");
    renderBitmapString(-0.88, 0.82, 0.0, GLUT_BITMAP_TIMES_ROMAN_24, (char*)"Group Member :");
    ...
    glVertex2f(0.88, 0.8);
    glEnd();
    renderBitmapString(-0.78, 0.75, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, (char*) "ID");
    glLineWidth(3);
    glBegin(GL_LINES);
    glColor3f(0.0f, 0.0f, 0.0f);
    ...
    glEnd();
    renderBitmapString(-0.05, 0.75, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24,(char*) "Name");
    glLineWidth(3);
    glBegin(GL_LINES);
    glColor3f(0.0f, 0.0f, 0.0f);
    ...
    glVertex2f(0.24, 0.74);
    glEnd();
    renderBitmapString(0.68, 0.75, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24,(char*) "Contribution");
    glLineWidth(4);
    glBegin(GL_LINES);
    glColor3f(0.0f, 0.0f, 0.0f);
    glVertex2f(0.67, 0.74);
    ...
    glEnd();
    renderBitmapString(-0.84, 0.7, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, (char*)"21-45670-3");
    renderBitmapString(-0.22, 0.7, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, (char*) "MD. FAISAL");
    renderBitmapString(0.74, 0.7, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, (char*) "18");

    renderBitmapString(-0.84, 0.65, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, (char*)"21-45672-3");
    renderBitmapString(-0.22, 0.65, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, (char*)"ABIR HASAN");
    renderBitmapString(0.74, 0.65, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, (char*)"18");

    renderBitmapString(-0.84, 0.6, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, (char*)"21-45677-3");
    renderBitmapString(-0.22, 0.6, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, (char*)"MD. ATIK ULLAH KHAN");
    renderBitmapString(0.74, 0.6, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, (char*)"28");

    renderBitmapString(-0.84, 0.55, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, (char*)"21-45678-3");
    renderBitmapString(-0.22, 0.55, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, (char*)"MD. IFTEAR HOSSAIN RATUL");
    renderBitmapString(0.74, 0.55, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, (char*)"18");

    renderBitmapString(-0.84, 0.5, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, (char*)"21-45719-3");
    renderBitmapString(-0.22, 0.5, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, (char*)"TAHFIM IBN KHAN");
    renderBitmapString(0.74, 0.5, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, (char*)"18");
    ...
    glVertex2f(0.88, 0.45);
    glEnd();
    // Define a helper function to convert wide-character strings to regular character strings

    // Convert and render each string

    renderBitmapString(-0.1, 0.4, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, (char*)"Supervised by :");
    renderBitmapString(-0.13, 0.35, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, (char*)"Mahfujur Rahman");
    renderBitmapString(-0.07, 0.3, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, (char*)"Lecturer");
    renderBitmapString(-0.22, 0.25, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, (char*)"Department of Computer Science");
    renderBitmapString(-0.23, 0.2, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, (char*)"Faculty of Science and Technology");
    renderBitmapString(-0.34, 0.15, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, (char*)"American International University-Bangladesh(AIUB)");
...
void myKeyboard(unsigned char key, int x, int y)
{
    ...
    if (key == '1')
    {
        sndPlaySound(L"train.wav", SND_ASYNC);
    }

    if (key == '2')
    {
        sndPlaySound(L"bus.wav", SND_ASYNC);
    }
